...
public class Card {
    ...
    public Card(int value, int color) {
        ...
        switch(color){
            case 0: cc=Card_Color.HEARTHS;
                    break;
            case 1: cc=Card_Color.DIAMONDS;
            break;
            case 2: cc=Card_Color.CLUBS;
             break;
            case 3: cc=Card_Color.SPADES;
             break;
        }
        switch(value){
            case 0: cv=Card_Value.TWO;
                break;
            case 1: cv=Card_Value.THREE;
                break;
            case 2: cv=Card_Value.FOUR;
                break;
            case 3: cv=Card_Value.FIVE;
                break;
            case 4: cv=Card_Value.SIX;
                break;
            case 5: cv=Card_Value.SEVEN;
                break;
            case 6: cv=Card_Value.EIGHT;
                break;
            case 7: cv=Card_Value.NINE;
                break;
            case 8: cv=Card_Value.TEN;
                break;
            case 9: cv=Card_Value.JACK;
                break;
            case 10: cv=Card_Value.QUEEN;
                break;
            case 11: cv=Card_Value.KING;
                break;
            case 12: cv=Card_Value.ACE;
                break;
        }
        this.color=cc;
        this.value=cv;
